...
def register_room():
    ...
    has_instruments = input("Have bitch instruments [y, n]? ").lower().startswith('y')
    allow_deepthroat = input("Can you host cruel bitches [y, n]? ").lower().startswith('y')
    ...
    room = svc.register_room(
        ...
        allow_deepthroat, has_instruments, milf, price
    )
